/*
  ...
  - Made the column `content` on table `film_comment` required. This step will fail if there are existing NULL values in that column.
  ...
  - Made the column `created_at` on table `post_reaction` required. This step will fail if there are existing NULL values in that column.
...
-- AlterTable
ALTER TABLE "post_reaction" ALTER COLUMN "post_id" SET NOT NULL,
ALTER COLUMN "customer_id" SET NOT NULL,
ALTER COLUMN "created_at" SET NOT NULL;
