...
// let someValue = 'Hello, ozcodingschool' as String;
// let someValue = <string>'Hello, ozcodingschool';

// 'as' 구문 또는 '<>'구문을 사용하여 someValue를 문자열로 단언하고, 그 길이를 strLength에 할당하는 코드를 작성하세요.

/* 이 곳에 코드를 입력하세요.*/
// const strLength = someValue.length;
// const strLength = (someValue as string).length; // 'as' 구문을 사용한 타입 단언
const strLength = (<string>someValue).length; // '<>' 구문을 사용한 타입 단언
...
stringManager.addItem({ id: 1, value: "Hello World" });
stringManager.addItem({ id: 2, value: "Hi there" });
stringManager.addItem({ id: 3, value: "Typescript" });
...
numberManager.addItem({ id: 1, value: 1 });
numberManager.addItem({ id: 2, value: 2 });
numberManager.addItem({ id: 3, value: 3 });
